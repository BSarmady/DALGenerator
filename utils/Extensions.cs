...
namespace DALGenerator {
    ...
    internal static class Extensions {
        ...
        public static string PadStringAtNewLines(this object inString, string Padding = "        /// ") {
            return inString.ToString().Replace("\r\n", "\r\n" + Padding);
        }
        #endregion
        ...
        public static string SplitAtWords(this string inString, int maxlen = 80) {
